...
function Banner() {
  return (
    <div className=' min-h-screen bg-gradient-to-br from-gray-900 to-blue-900/30 relative overflow-hidden'>
        ...
        <div className='container mx-auto px-30 h-screen flex item-center'>
                ...
                <div className=' lg:col-span-1 flex flex-col justify-center space-y-6'>
                    ...
                    <motion.p initial={{ opacity: 0}}
                        ...
                        className='text-lg text-cyan-100/80'>
                            Explore our collection with dynamic preview and immersive interaction
                    </motion.p> 

                    <motion.button whileHover={{ scale : 1.05}}
                        whileTap={{ scale : 0.95}}
                        onClick={() => document.getElementById('hero').scrollIntoView({ behavior : 'smooth'})}
                        className='bg-gradient-to-r from-cyan-500 to-blue-600 w-fit px-6 py-3 rounded-full font-bold text-white shadow-lg hover:shadow-cyan-500/30 transition-all'>
                            Start Exploring
                    </motion.button>
                </div>
